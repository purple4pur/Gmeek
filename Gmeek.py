...
i18nCN={"Search":"搜索","switchTheme":"切换主题","home":"首页","comments":"评论","run":"本站存活 ","days":" 天","Previous":"上一页","Next":"下一页"}
...
class GMEEK():
    ...
    def createFeedXml(self):
        ...
        feed.link(href="/")
        feed.image(url=self.blogBase["avatarUrl"],title="avatar", link="/")
